...
private:
  ...
  std::array<double, 12> b2_stand_target_1_q_{};
  std::array<double, 12> b2_stand_target_2_q_{};
  std::array<double, 12> b2_stand_target_3_q_{};
  std::array<double, 12> b2_stand_target_4_q_{};
  std::array<double, 5> b2_stand_phase_durations_{};
  std::array<double, 12> b2_down_q_{};
  std::array<double, 12> b2_kp_by_joint_{};
  std::array<double, 12> b2_kd_by_joint_{};
